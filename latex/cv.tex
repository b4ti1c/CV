...
\cvitem{Military}{Postponed to 2021}
\cvitem{Languages}{
\begin{itemize}
\item Turkish -Native
...
\cventry{2015 -- Present}{SignAlive}{Core Full-Stack Developer}{}{}{SignAlive is an HTML5 signage platform that supports Linux, Mac, Windows, LG webOS Signage, LG webOS TV, iOS and Android devices. Currently we are building the system from scratch using state-of-the-art technologies and practices. The system runs as a collection of scalable micro-services habited on Amazon Web Services, and it is able to maintain an active socket connection with an infinite number of online devices with negligible delay.
\newline{}\newline{}
Tools used:
\begin{itemize}
\item Amazon Web Services (ECS, S3, Lambda)
